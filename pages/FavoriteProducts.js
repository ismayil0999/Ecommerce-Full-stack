...
export default function FavoriteProducts() {
  ...
  return (
    <div className='flex items-center flex-col w-full gap-[20px]'>
      ...
      {favoriteProducts.length > 0 ?   <div className="w-full bg-[#F6F7FA] pt-[50px] grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 p-[10px] gap-[10px] place-items-center pb-[50px]">
